 ...
 */
public class CategoryIntegration extends GuiConfigEntries.CategoryEntry {
    ...
    protected GuiScreen buildChildScreen() {
        return new GuiConfig(this.owningScreen,
                new ConfigElement(ConfigurationHandler.configuration.getCategory(Settings.INTEGRATION_CATEGORY)).getChildElements(),
                Reference.MOD_ID,
