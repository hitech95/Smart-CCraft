...
public class ContainerCommon extends Container {
    ...
    public ContainerCommon(InventoryPlayer inventoryPlayer, IInventory inventory) {
        this(inventoryPlayer, inventory, 84);
    }

    public ContainerCommon(InventoryPlayer inventoryPlayer, IInventory inventory, int inventoryBaseY) {
